...
export const ALIMENTS_REFERENCE: AlimentReference[] = [
  { id: 'poulet', nom: 'Blanc de poulet', emoji: '🍗', portionReference_g: 120,
    pour100g: { calories: 165, proteines_g: 31, lipides_g: 3.6, glucides_g: 0, micros: { vitamineB6_mg: 0.6, zinc_mg: 1 } } },
  { id: 'oeuf', nom: 'Œufs', emoji: '🥚', portionReference_g: 100, // ~2 œufs
  ...
  { id: 'noix', nom: 'Noix', emoji: '🌰', portionReference_g: 30,
  ...
  { id: 'graines_chia', nom: 'Graines de chia', emoji: '🌱', portionReference_g: 20,
  ...
  { id: 'beurre_cacahuete', nom: 'Beurre de cacahuète', emoji: '🥜', portionReference_g: 20,
