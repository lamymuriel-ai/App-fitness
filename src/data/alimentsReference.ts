...
export const ALIMENTS_REFERENCE: AlimentReference[] = [
  ...
  { id: 'sardines', nom: 'Sardines (conserve à l\'huile, égouttées)', emoji: '🐟', portionReference_g: 90, moments: ['repas', 'collation'],
  ...
  { id: 'poivron', nom: 'Poivron rouge', emoji: '🫑', portionReference_g: 100, moments: ['repas', 'collation'],
