...
export const MICRO_REFERENCE: MicronutrimentInfo[] = [
  ...
  { cle: 'magnesium_mg', label: 'Magnésium', unite: 'mg', reference: 360, emoji: '⚡' },
  { cle: 'zinc_mg', label: 'Zinc', unite: 'mg', reference: 11, emoji: '🛡️' },
  { cle: 'vitamineA_ug', label: 'Vitamine A', unite: 'µg', reference: 650, emoji: '👁️' },
  { cle: 'vitamineC_mg', label: 'Vitamine C', unite: 'mg', reference: 110, emoji: '🍊' },
  { cle: 'vitamineD_ug', label: 'Vitamine D', unite: 'µg', reference: 15, emoji: '☀️' },
  { cle: 'vitamineE_mg', label: 'Vitamine E', unite: 'mg', reference: 11, emoji: '🌰' },
  { cle: 'vitamineB6_mg', label: 'Vitamine B6', unite: 'mg', reference: 1.6, emoji: '🧠' },
  { cle: 'vitamineB12_ug', label: 'Vitamine B12', unite: 'µg', reference: 4, emoji: '🔋' },
